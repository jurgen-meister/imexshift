...
//			for($i=0;$i<count($dataMovementDetail['SalDetail']);$i++){
//				$dataMovementDetail['SalDetail'][$i]['sal_sale_id'] = $idMovement;
//			}
//			for($i=0;$i<count($dataMovementDetail['SalDetail']);$i++){
//				$this->InvMovementDetail->create();
//				if(!$this->SalDetail->save($dataMovementDetail['SalDetail'][$i])){
//					$dataSource->rollback();
//					return 'error';
//				}
//			}
