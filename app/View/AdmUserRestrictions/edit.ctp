<div class="row-fluid">
	<div class="span9">
		<?php echo $this->BootstrapForm->create('AdmUserRestriction', array('class' => 'form-horizontal'));?>
			<fieldset>
				<legend><?php echo __('Edit %s', __('Adm User Restriction')); ?></legend>
				<?php
				...
				echo $this->BootstrapForm->input('adm_area_id', array(
					'required' => 'required',
					'helpInline' => '<span class="label label-important">' . __('Required') . '</span>&nbsp;')
				);
	...
	<div class="span3">
		...
		<ul class="nav nav-list">
			...
			<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AdmUserRestriction.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AdmUserRestriction.id'))); ?></li>
