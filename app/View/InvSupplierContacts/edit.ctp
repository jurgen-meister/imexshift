<div class="row-fluid">
	<div class="span9">
		<?php echo $this->BootstrapForm->create('InvSupplierContact', array('class' => 'form-horizontal'));?>
			<fieldset>
				<legend><?php echo __('Edit %s', __('Inv Supplier Contact')); ?></legend>
				<?php
	...
	<div class="span3">
		...
		<ul class="nav nav-list">
			...
			<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('InvSupplierContact.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('InvSupplierContact.id'))); ?></li>
